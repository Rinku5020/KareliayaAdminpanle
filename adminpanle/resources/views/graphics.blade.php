            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav " id="navbar-nav" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="" target="_blank" class="nav-link" data-key="t-horizontal">Demo1</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="" target="_blank" class="nav-link" data-key="t-horizontal">Demo2</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="" target="_blank" class="nav-link" data-key="t-horizontal">Demo3</a>
                                    </li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <a href="" class="btn btn-primary">Add Graphics & video</a>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <div class="row w-100">
                                            <div class="col-md-4">
                                                <select class="form-select">
                                                    <option class="form-select" selected>Select upload type</option>
                                                    <option class="form-select">Graphics</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
