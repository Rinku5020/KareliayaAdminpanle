                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive" style="overflow-x: auto;">
                                        <table id="add-rows" class="table table-bordered table-centered mb-0" style="min-width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th style="width: 33%; min-width: 200px;">Name</th>
                                                    <th style="width: 33%; min-width: 200px;">Type</th>
                                                    <th style="width: 34%; min-width: 300px;">Media</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($TableGraphics as $graphics)
                                                    <tr>
                                                        <td style="width: 33%; min-width: 200px;" class="text-truncate">{{ $graphics->name }}</td>
                                                        <td style="width: 33%; min-width: 200px;" class="text-truncate">{{ $graphics->type }}</td>
                                                        <td style="width: 34%; min-width: 300px;" class="text-center">
                                                            <div style="width: 100%; height: 150px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                                                @if (Str::endsWith($graphics->media_id, ['.mp4', '.avi', '.mov', '.mkv']))
                                                                    <video class="embed-responsive-item" controls style="max-width: 100%; max-height: 100%;">
                                                                        <source src="{{ asset('uploads/media/'. $graphics->media_id) }}" type="video/mp4">
                                                                    </video>
                                                                @else
                                                                    <img src="{{ asset('uploads/media/'. $graphics->media_id) }}" alt="" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                                                @endif
                                                            </div>
                                                        </td>
                                                    </tr>
