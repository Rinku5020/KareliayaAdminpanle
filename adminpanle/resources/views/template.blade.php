                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h5 class="card-title mb-0 flex-grow-1">Template</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="add-rows" class="table table-bordered table-centered mb-0" >
                                            <thead>
                                                <tr>
                                                    <th >SI.NO</th>
                                                    <th >Template</th>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-25" >
                                                            <button class="btn btn-primary">Save My Template</button>
                                                        </td>
